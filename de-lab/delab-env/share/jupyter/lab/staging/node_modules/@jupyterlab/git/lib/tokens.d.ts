...
export interface IGitExtension extends IDisposable {
     ...
     */
    readonly selectedHistoryFileChanged: ISignal<IGitExtension, Git.IStatusFile | null>;
    /**
     * A signal emitted when files that are behind the remote branch are opened.
     */
    readonly notifyRemoteChanges: ISignal<IGitExtension, Git.IRemoteChangedNotification | null>;
    /**
...
export declare namespace Git {
    namespace Diff {
         ...
         */
        interface IDiffWidget extends Widget {
            /**
             * Diff model
             */
         ...
         * will be displayed.
         */
        type ICallback = (model: IModel, toolbar?: Toolbar, trans?: ITranslator) => Promise<IDiffWidget>;
        /**
    ...
    type Status = 'untracked' | 'staged' | 'unstaged' | 'partially-staged' | 'remote-changed' | 'unmodified' | 'unmerged' | null;
 ...
 */
export declare enum ContextCommandIDs {
