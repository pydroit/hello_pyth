...
export class GitCommitGraph extends React.Component {
    ...
    getHeight() {
        return (this._graphData[this._graphData.length - 1].yOffset +
            this.props.getNodeHeight(this.props.commits[this.props.commits.length - 1].sha));
    }
...
//# sourceMappingURL=GitCommitGraph.js.map